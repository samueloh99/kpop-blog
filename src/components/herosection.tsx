...
export function HeroSection() {
  return (
    <div className="bg-alternative">
      <div className="flex flex-col max-w-[1440px] w-full m-auto text-white">
        <div className="flex flex-col w-full items-center justify-center relative h-[300px]">
          <h1 className="font-bold text-3xl text-highlightColor">
            Descubra as mais recentes novidades no mundo K-POP
          </h1>
          <p className="font-normal text-xl">
            Explore as notícias e novidades tudo em só um lugar
          </p>
          <div className="bg-default flex flex-col w-3/4 justify-center items-center absolute bottom-[-90px] text-white gap-9 py-5 rounded-lg shadow-md shadow-slate-800">
