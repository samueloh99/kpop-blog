...
export default function Home() {
  return (
    <main className="flex flex-col max-w-[1440px] w-full m-auto border border-black min-h-screen">
      <div className="flex flex-col w-full items-center justify-center relative border border-black h-[300px]">
        ...
        <div className="bg-default flex flex-col w-3/4 justify-center items-center border border-black absolute bottom-[-90px] text-white gap-9 py-5 rounded-lg">
